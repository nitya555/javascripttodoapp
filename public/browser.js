...
document.addEventListener("click",function(e){
    ...
    if(e.target.classList.contains("delete-me")){
        if(confirm("Can you please confirm to delete permanently?")){
    ...
    if(e.target.classList.contains("edit-me")){
       ...
       if(userInput){ axios.post("/update-item",{text: userInput, id: e.target.getAttribute("data-id")}).then(function(  
        ){
